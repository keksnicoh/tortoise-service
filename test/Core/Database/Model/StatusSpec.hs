...
mkSpec env = do
  ...
  describe "insertStatusRepository" $ do
    let record = C.Status UUID.nil (Just 10) (Just 10) (Just 6) Nothing (read "2011-11-19 18:28:23Z")
  ...
  describe "mkFetchStatusRepository" $ do
    let record = C.Status UUID.nil (Just 10) (Just 10) (Just 3) (Just 0) (read "2011-11-19 18:28:33Z")
        records =
          [ record
  ...
  describe "fetchStatusPeriodRepository" $ do
    let record = C.Status UUID.nil (Just 10) (Just 10) (Just 5) Nothing (read "2011-11-19 18:28:33Z")
        records =
          [ record
              { C.statusId = read "550e8400-e29b-11d4-a716-446655440000"
              , C.created = read "2011-11-19 18:28:23Z"
